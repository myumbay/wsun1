...
class Producto
{
    ...
    */
     ...
     * Add child
     *
     * @param \WsunBundle\Entity\Categoria $child
     *
     * @return Producto
     */
    public function addChild(\WsunBundle\Entity\Categoria $child)
    {
        $this->child[] = $child;
     ...
     * @param \WsunBundle\Entity\Categoria $child
     */
    public function removeChild(\WsunBundle\Entity\Categoria $child)
    {
     ...
     * @return Producto
     */
    public function addEmpresaProducto(\WsunBundle\Entity\EmpresaProducto $empresaProducto)
    {
